...
public class RegisterFarm_EnterOTPPage extends BasePage{
	...
	@AndroidFindBy(id = "re_enter_phone_number_btn") 
	private MobileElement re_enter_phone_number_btn;
	...
	public JSONObject getPage() {
		...
		obj.put("change_your_mobile_number",re_enter_phone_number_btn.getText());
